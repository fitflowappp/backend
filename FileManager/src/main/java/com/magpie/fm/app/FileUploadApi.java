...
public class FileUploadApi {
	...
	@ResponseBody
	public List<ResourceRef> uploadStandaloneFile(final HttpServletRequest request,
		...
		// adminActionService.uploadResource(user.getId(), resource.getId(),
		// BaseUtil.getRequestParam(request));
		// }
		return resources;
...
//	@ResponseBody
//	public ResourceRef saveBase64Image(@ActiveUser UserRef userRef, @RequestBody Base64Image image) {
