...
public class Milestone {
	...
	private String id;
	//	Frequency of total exercise minutes completed with which to give achievement	Admin create new or edit	Integer	Minutes	30	300	60
	private int achievementMinutes;
	//	Frequency of total workout number completed with which to give achievement	Admin create new or edit	Integer	Workouts	1	20	5
